...
## flipper and bill lengths, as Gao et al. [2020] does. 
...
plot_penguins = ggplot(df, aes(x = x, y = y)) + 
  ...
  scale_color_manual(values = c("1" = "#898989", 
                                ...
                                "5" = "#64379E", 
                                "6" = "#67B3C9")) + 
  labs(title = "Visualization of Penguin Data", 
...
to_save = "workspaces/fig_penguins.RData"
...
to_save = "plots/fig_penguins.png"
...
to_save = "results/fig_penguins.txt"
